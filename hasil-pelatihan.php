				...
				<div class="col-lg-12">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li ><a href="parameter-pelatihan.php?idPelatihan=<?=($_REQUEST['idPelatihan']) ? $_REQUEST['idPelatihan'] : ''?>#parameter-pelatihan">Parameter</a></li>
							<li><a  href="ekstraksi-pelatihan.php?idPelatihan=<?=($_REQUEST['idPelatihan']) ? $_REQUEST['idPelatihan'] : ''?>#ekstraksi-pelatihan">Ekstraksi</a></li>
							<li class="active"><a href="#hasil-pelatihan" data-toggle="tab">Hasil</a></li>
						</ul>
						<div class="tab-content">
							<div class="active tab-pane" id="hasil-pelatihan">
								<div class="box box-info">
									<div class="box-header with-border">
										<h3 class="box-title">Hasil Pelatihan dari data Opname berdasarkan Jenis Produk</h3>
