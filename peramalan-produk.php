...
$selectPelatihan = $db->row("SELECT a.idPelatihan, a.idProduk, a.idSize, b.neuronFrom,b.neuronTo, b.weight,b.jenis
					FROM pelatihan AS a
					LEFT JOIN bobotpelatihan AS b ON a.idPelatihan = b.idPelatihan
					WHERE a.idProduk = '%s' AND a.idSize = '%s'",$ekstraksiPrefill->idProduk,$ekstraksiPrefill->idSize);
foreach ($db->table("SELECT a.`idProduk`, LEFT(c.`tanggalOpname`, 7) bulan, Year(c.`tanggalOpname`) ye,  Month(c.`tanggalOpname`) mo, 
				...
				SUM(b.`prevQty` - b.`qty`) terjual, b.`prevQty` AS stokAwal
				FROM `produk` a
				...
				GROUP BY a.`idProduk`, LEFT(c.`tanggalOpname`, 7)",$tanggalKemarinAwal, $tanggalKemarinAkhir,$ekstraksiPrefill->idProduk,$ekstraksiPrefill->idSize) as $row)
				...
				<div class="col-lg-12">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							...
							<li><a  href="hasil-peramalan-produk.php?idPelatihan=<?=($_REQUEST['idPelatihan']) ? $_REQUEST['idPelatihan'] : ''?>">Hasil</a></li>
						</ul>
						<div class="tab-content">
							<div class="active tab-pane" id="peramalan">
								<div class="box box-info">
									<div class="box-header with-border">
										<h3 class="box-title">Ekstraksi dari data Opname berdasarkan Produk</h3>
									</div>
												...
												<div class="box-footer">
													...
													<?php if ($normalized):?>
														<div class="pull-right">
															...
															<a href="backprop-peramalan-produk.php?idPeramalan=<?=$_REQUEST['idPeramalan'];?>&idPelatihan=<?=$selectPelatihan->idPelatihan;?>" target="_blank"><button type="button" value="Proses"class="btn btn-info">Proses</button></a>
														</div>
