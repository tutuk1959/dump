				...
				<div class="col-lg-12">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							...
							<li><a  href="hasil-pelatihan.php?idPelatihan=<?=($_REQUEST['idPelatihan']) ? $_REQUEST['idPelatihan'] : ''?>">Hasil</a></li>
						</ul>
												...
												<div class="box-footer">
													...
													<?php if ($normalized):?>
														<div class="pull-right">
															...
															<a href="backprop.php?idPelatihan=<?=$_REQUEST['idPelatihan'];?>" target="_blank"><button type="button" value="Proses"class="btn btn-info">Proses</button></a>
														</div>
