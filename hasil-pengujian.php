							...
							<div class="active tab-pane" id="hasil-pengujian">
								<div class="box box-info">
									<div class="box-header with-border">
										<h3 class="box-title">Hasil Pengujian dari data Opname berdasarkan Jenis Produk</h3>
										...
										<div class="box-body">
											<section>
											<?php
												$pelatihanSummary = $db->row("SELECT a.tanggalPelatihan, a.learningRate, a.hiddenNeuron,b.jenisProduk,c.size,d.MAPE, d.trackingSignal
												FROM pelatihan AS a
