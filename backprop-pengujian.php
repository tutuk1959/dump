				...
				<div class="col-lg-12">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li ><a href="parameter-pengujian.php?jenisProduk=<?=$_REQUEST['idJenis'];?>&size=<?=$_REQUEST['idSize'];?>&outlet=<?=$_REQUEST['idOutlet']?>&idPelatihan=<?=$_REQUEST['idPelatihan'];?>">Parameter</a></li>
							<li class="active"><a href="#ekstraksi-pelatihan" data-toggle="tab">Ekstraksi</a></li>
							<li><a  href="hasil-pengujian.php?idPelatihan=<?=($_REQUEST['idPelatihan']) ? $_REQUEST['idPelatihan'] : ''?>&idPengujian=<?=$_REQUEST['idPengujian']?>">Hasil</a></li>
						</ul>
						<div class="tab-content">
							<div class="active tab-pane" id="ekstraksi-pelatihan">
								<div class="box box-info">
									<div class="box-header with-border">
										<h3 class="box-title">Pengujian dari data Opname berdasarkan Jenis Produk</h3>
									</div>
										...
										<div class="box-body">
												...
												<table class="table table-bordered table-striped dataTable"  border="1">
													...
													$db->exec("UPDATE pengujian SET MAPE = '%s', trackingsignal = '%s', isValid = '%s' WHERE idPengujian = '%s'",$mape,$trackingsignal,$isValid,$_REQUEST['idPengujian']);
													?>
													</tbody>
												</table>
												<?php showMessageAndErrors($message,$error);?>
												<div class="box-footer">
													<a href="ekstraksi-pengujian.php?idProduk=<?=$v->idProduk;?>&idSize=<?=$v->idSize;?>&idOutlet=<?=$v->idOutlet?>&idPelatihan=<?=$v->idPelatihan;?>"class="btn btn-info pull-left">Back</a>
