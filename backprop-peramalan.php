				...
				<div class="col-lg-12">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li ><a href="peramalan.php?idPeramalan=<?=($_REQUEST['idPeramalan']) ? $_REQUEST['idPeramalan'] : ''?>">Ekstraksi</a></li>
							...
							<div class="active tab-pane" id="peramalan">
								<div class="box box-info">
									<div class="box-header with-border">
										<h3 class="box-title">Hasil Peramalan berdasarkan Jenis Produk</h3>
									</div>
										...
										<div class="box-body">
												...
												<section>
											<?php
												$peramalanSummary = $db->row("SELECT a.tanggalTujuan,b.jenisProduk,c.size
												FROM peramalan AS a
											...
											?>
												<table border="0" class="table table-bordered dataTable">
													<tr>
														<td colspan="4" align="center"><strong><?=$peramalanSummary->jenisProduk;?>,Size <?=$peramalanSummary->size;?></strong></td>
													</tr>
													<tr>
