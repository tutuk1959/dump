								...
								<div class="box box-info">
									<div class="box-header with-border">
										...
										<div class="col-lg-6 pull-right">
												<a style="float: right;margin-bottom: 10px !important;" href="laporan-pengujian-pelatihan.php?idPelatihan=<?=$_REQUEST['idPelatihan'];?>">
										...
										<div class="box-body">
											<section>
											<?php
												$pelatihanSummary = $db->row("SELECT a.tanggalPelatihan, a.learningRate, a.hiddenNeuron,b.idJenis,b.jenisProduk,c.size
												FROM pelatihan AS a
										...
										<div class="box-footer">
											<a href="pengujian-jenis.php?" class="btn btn-info pull-left">Back</a>
