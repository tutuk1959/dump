...
Template::reportHead('Laporan Hasil Pengujian','pasok.php');;
?>
			...
			<section class="invoice" style="margin:10px 0px !important;">
				<div class="col-xs-12">
					<h3 class="page-header">
						<i class="fa fa-globe"></i> Laporan Hasil Pengujian <?=$prefillOutlet->namaOutlet;?> , <?=Template::format($prefillSupply->tanggalSupply,"date");?>
					</h3>
				...
				<div class="row">
					<div class="col-lg-12">
						<?php
							...
							LEFT JOIN pengujian AS d ON d.idPelatihan = d.idPengujian
