				...
				<div class="col-lg-12">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							 ...
							 <li><a class="active" href="ekstraksi-pelatihan.php">Ekstraksi</a></li>
							...
							<div class="active tab-pane" id="bobot-pelatihan">
								<div class="box box-info">
									<div class="box-header with-border">
										<h3 class="box-title">Pelatihan dari data Opname berdasarkan Jenis Produk</h3>
									</div>
										...
										<div class="box-body">
												...
												<?php
													...
													$db->exec("DELETE FROM bobotpelatihan WHERE idPelatihan=%d", $_REQUEST['idPelatihan']);
													foreach ($bp->v as $i=>$v){
														foreach ($v as $j=>$vv)
												...
												<div class="box-footer">
													<a href="ekstraksi-pelatihan.php?idPelatihan=<?=($_REQUEST['idPelatihan']) ? $_REQUEST['idPelatihan'] : ''?>"class="btn btn-info pull-left">Back</a>
