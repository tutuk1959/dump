...
if ($_REQUEST['mode'] == 'insert') {
	...
	if (!$error){
		...
		$db->exec("INSERT INTO peramalan(tanggalPeramalan,idProduk, idSize, idOutlet, idJenis,tanggalTujuan) VALUES ('%s','%s','%s','%s','%s','%s')",$tanggalPeramalan,$_REQUEST['produk'],$_REQUEST['size'],$_REQUEST['outlet'],0,$tanggalRamal);
							...
							<div class="active tab-pane" id="parameter-pelatihan">
								<div class="box box-info">
									<div class="box-header with-border">
										<h3 class="box-title">Peramalan JST dari Produk</h3>
									</div>
										...
										<div class="box-body">
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<select name="produk"class="form-control" <?=($_REQUEST['idPelatihan']) ? 'disabled' : ''?>>
											...
											<div class="box-footer">
												...
												<a style="margin-right:5px;"href="peramalan-produk.php?idPeramalan=<?=($_REQUEST['idPeramalan'] ? $_REQUEST['idPeramalan']: $idMasterperamalan);?>" class="pull-right">
