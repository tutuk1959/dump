...
if ($_REQUEST['mode'] == 'insert' && $_REQUEST['simpan'] == 'Simpan'){
	...
	foreach($_REQUEST['bulan'] as $k=>$v){
		...
		if (! $error){
			$db->exec("INSERT INTO inputpelatihan(idPelatihan,x1,x2,x3,y,x1n,x2n,x3n,yn) VALUES ('%s','%s','%s','%s','%s','%s','%s','%s','%s')",
					$_REQUEST['idPel'], $_REQUEST['terjualLalu'][$k], $_REQUEST['harga'][$k], $_REQUEST['stokAwal'][$k],
				...
				<div class="col-lg-12">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li ><a href="parameter-pelatihan-produk.php?idPelatihan=<?=($_REQUEST['idPelatihan']) ? $_REQUEST['idPelatihan'] : ''?>#parameter-pelatihan">Parameter</a></li>
							<li class="active"><a href="#ekstraksi-pelatihan" data-toggle="tab">Ekstraksi</a></li>
							<li><a  href="hasil-pelatihan-produk.php?idPelatihan=<?=($_REQUEST['idPelatihan']) ? $_REQUEST['idPelatihan'] : ''?>">Hasil</a></li>
						</ul>
												...
												<div class="box-footer">
													...
													<?php if ($normalized):?>
														<div class="pull-right">
															...
															<a href="backprop-produk.php?idPelatihan=<?=$_REQUEST['idPelatihan'];?>" target="_blank"><button type="button" value="Proses"class="btn btn-info">Proses</button></a>
														</div>
