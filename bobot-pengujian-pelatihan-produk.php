							...
							<div class="active tab-pane" id="bobot-pelatihan">
								<div class="box box-info">
									<div class="box-header with-border">
										<h3 class="box-title">Pelatihan Kembali Pengujian dari data Opname berdasarkan Produk</h3>
									</div>
										...
										<div class="box-body">
												...
												<div class="box-footer">
													<a href="pengujian-produk.php?idPelatihan=<?=($_REQUEST['idPelatihan']) ? $_REQUEST['idPelatihan'] : '';?>&idPengujian=<?=($_REQUEST['idPengujian']) ? $_REQUEST['idPengujian'] : '';?>"class="btn btn-info pull-left">Back</a>
