				...
				<div class="col-lg-12">
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							...
							<li><a  href="ekstraksi-pelatihan-produk.php?idPelatihan=<?=($_REQUEST['idPelatihan']) ? $_REQUEST['idPelatihan'] : ''?>#ekstraksi-pelatihan">Ekstraksi</a></li>
							<li class="active"><a href="#hasil-pelatihan" data-toggle="tab">Ekstraksi</a></li>
						</ul>
						<div class="tab-content">
							<div class="active tab-pane" id="hasil-pelatihan">
								<div class="box box-info">
									<div class="box-header with-border">
										<h3 class="box-title">Hasil Pelatihan dari data Opname berdasarkan Produk</h3>
										<div class="col-lg-6 pull-right">
												<a style="float: right;margin-bottom: 10px !important;" href="laporan-pelatihan.php?idPelatihan=<?=$_REQUEST['idPelatihan'];?>">
										...
										<div class="box-body">
											<section>
											<?php
												$pelatihanSummary = $db->row("SELECT a.tanggalPelatihan, a.learningRate, a.hiddenNeuron,b.idProduk,b.namaProduk,c.size
												FROM pelatihan AS a
											...
											<section class="connectedSortable">
												<div class="nav-tabs-custom">
													...
													<script src="graph-mse.php"></script>
													</div>
												</div>
											</section>
										...
										<div class="box-footer">
											<a href="pelatihan-mainpage.php?" class="btn btn-info pull-left">Back</a>
